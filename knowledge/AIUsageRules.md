...
- Financial V2 chỉ giải thích bằng chứng đã có: `research_stance` không phải execution order, và Tactical Entry Readiness không phải Security Research Stance. Không dùng Financial V2 để thay đổi `entry_state`, `entry_action`, confirmation/invalidation, portfolio fit, hay research queue priority của Producer.
