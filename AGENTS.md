...
Codex is the executor. Consumer preserves qualified Producer contracts and fails closed; it must not infer missing source semantics or upgrade blocked current-market states. Read Producer canonical governance at `../stock-core-private/docs/` before work.
