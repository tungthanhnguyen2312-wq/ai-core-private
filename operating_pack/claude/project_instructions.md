...
Do not expand evidence with general knowledge or external tools unless explicitly authorized and separately sourced.

## Known Limitations

Exact Claude Project setup UI, limits and retrieval semantics are not fully confirmed in this local phase.

## How AI Should Use This

If context retrieval omits a required file or section, request the file or state the missing evidence rather than guessing.
